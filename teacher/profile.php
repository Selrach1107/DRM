        ...
        <div class="row justify-content-center">
            <div class="col-mid-6 mt-2">
                <div class="card mt-4 ml-5 mr-5  bg-light" style="width:400px; height: 420px;">
                    <img class="card-img-top mt-4" src="../images/student.png" alt="Card image" style="width:40%">
                    <div class="card-body">
                        <br>
                      <h4 class="card-title">RENATO BAUTISTA</h4>
                      <p class="card-text"><strong>Status: </strong>TEACHER</p>
                      <p class="card-text"><strong>Teachers ID: </strong>123456</p>
            ...
            <div class="col-mid-6 mt-2">
                <div class="card mt-4 mb-4 ml-5 mr-5" style="width:400px; height: 420px;">
                      ...
                      <form>
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="first_name" placeholder="RENATO" readonly name="first_name">
                            </div>
                            <div class="col">
                                <label for="last_name">Last Name:</label>
                                <input type="text" class="form-control" id="last_name" placeholder="BAUTISTA" readonly name="first_name">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mt-2">
                                <label for="teacher_id">Teacher ID:</label>
                                <input type="text" class="form-control" id="teacher_id" placeholder="123456" readonly name="teacher_id">
                            </div>
                            <div class="col mt-2">
                        ...
                        <div class="row">
                            <div class="col mt-2">
                                ...
                                <input type="text" class="form-control" id="email" placeholder="renato@gmail.com" readonly name="email">
                            </div>
                        </div>
                      </form>
                    </div>
